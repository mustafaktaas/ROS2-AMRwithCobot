...
def generate_launch_description():
    ...
    pkg_name = 'diffamr2_description'
    use_sim_time = LaunchConfiguration('use_sim_time', default='true')   
    file_subpath = os.path.join(get_package_share_directory(pkg_name),'urdf','diffamr.urdf.xacro')
    ...
    diffamr_diff_drive_controller_spawn = Node(
      package="controller_manager",
      executable="spawner",
      arguments=["diffamr_diff_drive_controller"]
      )
    ...
    return LaunchDescription([
        ...
        diffamr_diff_drive_controller_spawn,
