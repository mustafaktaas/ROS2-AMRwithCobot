...
def generate_launch_description():
    ...
    file_subpath = os.path.join(get_package_share_directory(package_name),'rviz','diffamr.rviz')

    desc_start = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory(package_name),'launch','diffamr_description_rsp.launch.py'
